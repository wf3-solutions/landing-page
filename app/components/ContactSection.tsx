  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch(
        "https://formsubmit.co/ajax/contato@wf3solutions.com",
        {
          method: "POST",
          headers: {
      ...
      if (error instanceof Error && error.name === "AbortError") {
        ...
        setErrorMessage(
          "Erro de conexão. Verifique se não há bloqueadores de anúncio impedindo o envio."
        );
      }
    } finally {
    ...
    >
      ...
      >
        <motion.div
          ...
          className="flex mt-[-2rem] flex-col justify-center gap-2 text-center md:text-left"
        >
          <h1 className="text-[clamp(1rem,5vw,3rem)] font-bold leading-tight text-primary">
            Vamos conversar
          </h1>
