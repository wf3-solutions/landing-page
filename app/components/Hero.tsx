...
export default function HeroSection() {
  ...
  "
		>
			...
			>
				<motion.h1 variants={itemVariants} className="text-background text-3xl text-center md:text-left  md:text-5xl font-bold ">
					Transforme Ideias em <br /> <span className="text-4xl ">Software Inteligente.</span>
				</motion.h1>

				<motion.p variants={itemVariants} className="text-xl px-4 md:px-0 text-background mt-2 text-center md:text-left md:w-[50%]">
					Desenvolvemos aplicações web, mobile e sistemas completos, unindo tecnologia avançada, design inteligente e alta
					performance para impulsionar o crescimento da sua empresa.
				</motion.p>
